...
public interface ItemHandle {
     ...
     */
    void setName(@NotNull final ItemStack item, @NotNull final BaseComponent name);
     ...
     */
    void setLore(@NotNull final ItemStack item, @NotNull final List<BaseComponent> lore);
