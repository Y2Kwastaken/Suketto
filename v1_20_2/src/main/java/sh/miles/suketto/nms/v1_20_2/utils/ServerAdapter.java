package sh.miles.suketto.nms.v1_20_2.utils;
...
/**
 * Nms Chat utils for 1.20.2 intended for internal use
 */
public final class ServerAdapter {
    ...
    @NotNull
    public static Block toMinecraftBlock(@NotNull final Material material) {
